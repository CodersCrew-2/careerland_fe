                ...
                <div className="rounded-3xl overflow-hidden"
                    ...
                    <div className="px-8 pt-8 pb-7 space-y-5">
                        ...
                        <div className="text-center space-y-1">
                            <h1 className="text-[26px] font-bold text-slate-800">Join the Future</h1>
                            <p className="text-[13px] text-slate-400">Start your career journey today</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3.5">
                            ...
                            <Field label="Password" type="password" value={password} onChange={setPassword}
                                placeholder="Create a password" icon={Lock} required />

                            <button type="submit"
                                className="w-full h-12 rounded-2xl font-semibold text-white text-[14px] transition-all hover:scale-[1.01] active:scale-[0.98] mt-1"
